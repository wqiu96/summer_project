# -*- coding: utf-8 -*-
"""config_pytorch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/wqiu96/summer_project/blob/master/DeepBSDE_pytorch/config_pytorch.ipynb
"""
...
class HJBConfig(Config):
    ...
    #num_hiddens = [dim, dim+10, dim+10, dim]
    #num_hiddens = [dim, dim+1, dim+1, dim]
    num_hiddens = [dim, dim, dim]
    y_init_range = [0, 1]
